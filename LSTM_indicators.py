############# ESTA TREINANDO TODOS OS INDICADORES BEM, NAO SEI FALAR AGORA MAS PARECE BOM SE LAPIDAR, VOU TENTAR ISOLAR CADA INDICADOR NAS PROXIMAS
...
def download_data(symbol, period="1y", interval="M30"):
